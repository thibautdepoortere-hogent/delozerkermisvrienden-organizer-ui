...
class FormulierNieuweAanvraag extends Formulier {
          ...
          <div>
            ...
            {this.genereerBelangrijkeMededeling(
              ...
              "Bij het plannen van de standen zal er zoveel mogelijk rekening gehouden worden met de ingegeven voertuigen." +
                "Let wel, mogelijks kunenn niet àlle ingevulde voertuigen aan de stand staan.",
              "Primary",
              "info-sign"
            )}
            {this.genereerFormulierGroep([
  ...
  verzendFormulier = async () => {
    ...
    if (id) {
      ...
      this.props.history.push("/inschrijvingen/ingediend/" + id);
    } else {
      this.setState({ opdrachtVerwerken: false });
    }
  };
  ...
  isBetaalmethodeNogGeldig = (betaalmethode) => {
    ...
    return betaalmethodenService.isBetaalmethodeNogGeldig(
      betaalmethode,
      beginPeriode,
      eindePeriode
    );
